    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={() => loadProfile({ refresh: true })} colors={['#17843f']} />}>
      ...
      {user && account ? (
        <View style={styles.profileCard}>
          ...
          <Text style={styles.photoNote}>Profile photos are not supported by the current Cleanify user schema.</Text>
...
const styles = StyleSheet.create({
  ...
  profileCard: { backgroundColor: '#fff', padding: 20, borderRadius: 16, borderWidth: 1, borderColor: '#e5e9e7', alignItems: 'center', marginBottom: 26 }, avatar: { width: 84, height: 84, borderRadius: 42, backgroundColor: '#17843f', alignItems: 'center', justifyContent: 'center' }, avatarText: { color: '#fff', fontSize: 32, fontWeight: '800' }, name: { marginTop: 14, fontSize: 21, fontWeight: '800', color: '#111827' }, email: { marginTop: 4, color: '#667085', fontSize: 14 }, details: { alignSelf: 'stretch', marginTop: 18, gap: 10 }, detail: { color: '#374151', fontSize: 14 }, photoNote: { marginTop: 16, color: '#8a9390', fontSize: 12, textAlign: 'center' }, editButton: { marginTop: 16, minHeight: 46, alignSelf: 'stretch', borderWidth: 1, borderColor: '#17843f', borderRadius: 10, flexDirection: 'row', gap: 9, alignItems: 'center', justifyContent: 'center' }, editText: { color: '#17843f', fontWeight: '700' },
